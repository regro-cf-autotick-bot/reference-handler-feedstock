...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/reference-handler-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12739&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/reference-handler-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `reference-handler` can be installed with:

```
conda install reference-handler
```

It is possible to list all of the versions of `reference-handler` available on your platform with:
